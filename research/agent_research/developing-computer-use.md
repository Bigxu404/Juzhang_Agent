description: This article introduces Claude's computer use capabilities, discussing the research breakthroughs in training models to precisely control a mouse and keyboard by interpreting screenshots, as well as the safety evaluations regarding prompt injections and misuse.
